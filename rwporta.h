...
char *buffer_read_buffertostring(uint8 **curPos, int length, char *buf, int bufLen);
#define buffer_read_string buffer_read_buffertostring
char *buffer_read_buffertostring_noup(uint8 *curPos, int length, char *buf, int bufLen);
